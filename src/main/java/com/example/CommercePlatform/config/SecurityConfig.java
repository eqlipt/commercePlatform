package com.example.CommercePlatform.config;

import com.example.CommercePlatform.services.PersonDetailsService;
...
//                .csrf().disable()
                ...
                .antMatchers("/product/add", "/product/{id}/edit").hasRole("SUPPLIER")
                .antMatchers("/cart/**", "/order/**").hasRole("CUSTOMER")
                .antMatchers("/sales/**").hasRole("SUPPLIER")
                .antMatchers("/product/{id}/delete").hasAnyRole("SUPPLIER", "ADMIN")
                ...
                .antMatchers("/js/**", "/css/**", "/img/**", "/auth/**", "/error", "/shop", "/shop/{id}").permitAll()
//                .anyRequest().hasAnyRole("SUPPLIER", "ADMIN", "CUSTOMER")
                ...
                // Спринг секьюрити будет ждать логин и пароль с формы и затем сверит их с данными в БД
